...
void SGraphNode_GrammarExecRuleNode::Construct(const FArguments& InArgs, UEdGraphNode_GrammarExecNodeBase* InNode) {
    GraphNode = InNode;
...
FLinearColor SGraphNode_GrammarExecRuleNode::InactiveStateColor(0.08f, 0.08f, 0.08f);
FLinearColor SGraphNode_GrammarExecRuleNode::ActiveStateColorDim(0.4f, 0.3f, 0.15f);
FLinearColor SGraphNode_GrammarExecRuleNode::ActiveStateColorBright(1.f, 0.6f, 0.35f);
FLinearColor SGraphNode_GrammarExecRuleNode::ErrorColor(1.f, 0.1f, 0.0f);

FSlateColor SGraphNode_GrammarExecRuleNode::GetBorderBackgroundColor() const {
    UEdGraphNode_GrammarExecRuleNode* RuleNode = Cast<UEdGraphNode_GrammarExecRuleNode>(GetNodeObj());
...
const FSlateBrush* SGraphNode_GrammarExecRuleNode::GetNameIcon() const {
    return FAppStyle::GetBrush(TEXT("Graph.StateNode.Icon"));
}

FText SGraphNode_GrammarExecRuleNode::GetExecutionTypeText() const {
    UEdGraphNode_GrammarExecRuleNode* RuleNode = Cast<UEdGraphNode_GrammarExecRuleNode>(GetNodeObj());
    if (RuleNode) {
...
void SGraphNode_GrammarExecRuleNode::UpdateGraphNode() {
    InputPins.Empty();
    OutputPins.Empty();
    ...
    [
        SNew(SBorder)
			...
			.Padding(0)
			.BorderBackgroundColor(this, &SGraphNode_GrammarExecRuleNode::GetBorderBackgroundColor)
        [
            SNew(SOverlay)
                ...
                [
                    ...
                    [
                        SNew(STextBlock)
								...
								.Text(this, &SGraphNode_GrammarExecRuleNode::GetEditableNodeTitleAsText)
                    ...
                    [
                        SNew(STextBlock)
								.Justification(ETextJustify::Center)
								.Text(this, &SGraphNode_GrammarExecRuleNode::GetExecutionTypeText)
                    ]
                ]
            ]
        ]
...
void SGraphNode_GrammarExecRuleNode::AddPin(const TSharedRef<SGraphPin>& PinToAdd) {
...
void SGraphNode_GrammarExecRuleNode::CreatePinWidgets() {
    UEdGraphNode_GrammarExecNodeBase* ExecNode = CastChecked<UEdGraphNode_GrammarExecNodeBase>(GraphNode);

...
FFlowExecConnectionDrawingPolicy::FFlowExecConnectionDrawingPolicy(
...
void FFlowExecConnectionDrawingPolicy::DetermineWiringStyle(UEdGraphPin* OutputPin, UEdGraphPin* InputPin, /*inout*/
    ...
    if (OutputPin && InputPin) {
        UFlowExecEdGraphNodeBase* SourceNode = Cast<UFlowExecEdGraphNodeBase>(OutputPin->GetOwningNode());
        UFlowExecEdGraphNodeBase* DestNode = Cast<UFlowExecEdGraphNodeBase>(InputPin->GetOwningNode());
...
void FFlowExecConnectionDrawingPolicy::Draw(TMap<TSharedRef<SWidget>, FArrangedWidget>& InPinGeometries,
...
void FFlowExecConnectionDrawingPolicy::DetermineLinkGeometry(FArrangedChildren& ArrangedNodes,
...
void FFlowExecConnectionDrawingPolicy::DrawPreviewConnector(const FGeometry& PinGeometry,
...
void FFlowExecConnectionDrawingPolicy::DrawSplineWithArrow(const FVector2D& StartAnchorPoint,
...
void FFlowExecConnectionDrawingPolicy::Internal_DrawLineWithArrow(const FVector2D& StartAnchorPoint,
                                                                      const FVector2D& EndAnchorPoint,
                                                                      const FConnectionParams& Params) {
...
void FFlowExecConnectionDrawingPolicy::DrawSplineWithArrow(const FGeometry& StartGeom, const FGeometry& EndGeom,
                                                               const FConnectionParams& Params) {
...
void FFlowExecConnectionDrawingPolicy::DrawConnection(int32 LayerId, const FVector2D& Start, const FVector2D& End,
                                                          const FConnectionParams& Params) {

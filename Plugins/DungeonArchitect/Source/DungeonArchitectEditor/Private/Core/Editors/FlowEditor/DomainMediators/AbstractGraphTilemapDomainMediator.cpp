...
void FAbstractGraphTilemapDomainMediator::Initialize(TSharedPtr<FFlowDomainEdLayoutGraph> InDomainAbstractGraph,
...
void FAbstractGraphTilemapDomainMediator::OnAbstractNodeSelectionChanged(TArray<UFlowLayoutEdGraphNode*> EdNodes) {
    bool bChunkSelected;
...
void FAbstractGraphTilemapDomainMediator::OnTilemapItemWidgetClicked(const FGuid& InItemId, bool bDoubleClicked) {
    const TSharedPtr<FFlowDomainEdLayoutGraph> DomainAbstractGraphPtr = DomainAbstractGraph.Pin();

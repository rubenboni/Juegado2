...
UEdGraph_GrammarExec* FSnapMapEditorUtils::GetEdGraph(UGrammarExecutionScript* ExecScript) {
    return Cast<UEdGraph_GrammarExec>(ExecScript->EdGraph);
}
...
void FSnapMapEditorUtils::InitializeExecutionScript(UGrammarExecutionScript* InExecutionScript,
    ...
    UEdGraph_GrammarExec* ExecGraph = NewObject<UEdGraph_GrammarExec>(InExecutionScript, "EdGraph");
    InExecutionScript->EdGraph = ExecGraph;

    UEdGraphNode_GrammarExecRuleNode* StartExecNode = NewObject<UEdGraphNode_GrammarExecRuleNode>(ExecGraph);

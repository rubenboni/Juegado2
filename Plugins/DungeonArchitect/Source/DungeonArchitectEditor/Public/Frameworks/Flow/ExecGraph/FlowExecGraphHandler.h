...
DECLARE_DELEGATE_RetVal_OneParam(FReply, FExecGraphDelegate, TWeakObjectPtr<UFlowExecEdGraph>);
DECLARE_DELEGATE_OneParam(FExecGraphChangedDelegate, TWeakObjectPtr<UFlowExecEdGraph>);
...
class FFlowExecGraphHandler : public TSharedFromThis<FFlowExecGraphHandler> {
public:
    void Bind();

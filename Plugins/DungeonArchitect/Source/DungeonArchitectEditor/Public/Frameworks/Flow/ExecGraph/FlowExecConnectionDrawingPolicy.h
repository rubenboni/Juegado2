...
class DUNGEONARCHITECTEDITOR_API FFlowExecConnectionDrawingPolicy : public FConnectionDrawingPolicy {
protected:
    UEdGraph* GraphObj;
...
public:
    //
    FFlowExecConnectionDrawingPolicy(int32 InBackLayerID, int32 InFrontLayerID, float ZoomFactor,

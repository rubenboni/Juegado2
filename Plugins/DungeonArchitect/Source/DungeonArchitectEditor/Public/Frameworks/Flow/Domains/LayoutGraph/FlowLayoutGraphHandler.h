...
DECLARE_DELEGATE_RetVal_OneParam(FReply, FAbstractGraphDelegate, TWeakObjectPtr<UGridFlowLayoutEdGraph>);
DECLARE_DELEGATE_OneParam(FAbstractGraphChangedDelegate, TWeakObjectPtr<UGridFlowLayoutEdGraph>);
DECLARE_DELEGATE_OneParam(FAbstractGraphNodeDelegate, UEdGraphNode*);
DECLARE_DELEGATE_OneParam(FAbstractGraphSelectedNodeChangedDelegate, const TSet<class UObject*>&);

class FFlowLayoutGraphHandler : public TSharedFromThis<FFlowLayoutGraphHandler> {
public:
    void Bind();
...
public:
    ...
    FAbstractGraphNodeDelegate OnNodeDoubleClicked;
    FAbstractGraphSelectedNodeChangedDelegate OnNodeSelectionChanged;

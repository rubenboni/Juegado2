...
class DUNGEONARCHITECTEDITOR_API FGrammarExecGraphConnectionDrawingPolicy : public FConnectionDrawingPolicy {
protected:
    UEdGraph* GraphObj;
...
public:
    //
    FGrammarExecGraphConnectionDrawingPolicy(int32 InBackLayerID, int32 InFrontLayerID, float ZoomFactor,
...
class FEditorGrammarExecGraphSupport : public FGrammarExecGraphSupport {
public:

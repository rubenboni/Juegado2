...
#include "EdGraphNode_GrammarExecRuleNode.generated.h"

class UEdGraphPin;
class UGraphGrammarProduction;

UCLASS()
class DUNGEONARCHITECTEDITOR_API UEdGraphNode_GrammarExecRuleNode : public UEdGraphNode_GrammarExecNodeBase {

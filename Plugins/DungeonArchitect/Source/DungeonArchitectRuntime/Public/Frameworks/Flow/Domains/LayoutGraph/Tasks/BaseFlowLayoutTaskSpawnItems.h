...
#include "BaseFlowLayoutTaskSpawnItems.generated.h"
...
UCLASS(Abstract)
class DUNGEONARCHITECTRUNTIME_API UBaseFlowLayoutTaskSpawnItems : public UBaseFlowLayoutTask {
    GENERATED_BODY()
public:
    /**
    ...
    */
    UPROPERTY(EditAnywhere, Category = "Spawn Items")
    FFlowItemCustomInfo CustomItemInfo;

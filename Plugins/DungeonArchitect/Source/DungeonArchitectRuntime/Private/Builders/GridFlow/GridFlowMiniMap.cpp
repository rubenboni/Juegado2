...
void AGridFlowMiniMap::BuildLayout(UDungeonModel* DungeonModel, UDungeonConfig* DungeonConfig) {
    ...
    DungeonModel->GenerateLayoutData(LayoutData);
    {
        ...
        FVector TargetTranslation = GridFlowConfig->GridSize * FVector(GridFlowModel->TilemapBuildSetup.TilemapOffset.X, GridFlowModel->TilemapBuildSetup.TilemapOffset.Y, 0);
